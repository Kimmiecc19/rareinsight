        ...
        tabItem(
          ...
          fluidRow(
            wellPanel(
              ...
              # Warning
              tags$h4("REMINDER: This tool is for educational purposes only and does not replace professional medical or genetic consultation. Users are strongly encouraged to consult a genetic counsellor or clinician before drawing conclusions from variant information."),
        ...
        tabItem(
          ...
          tabsetPanel(
            tabPanel(
              ...
              p("REMINDER: This tool is for educational purposes only and does not replace professional medical or genetic consultation. Users are strongly encouraged to consult a genetic counsellor or clinician before drawing conclusions from variant information."),
              fluidRow(
                column( width = 12,
...
server <- function(input, output, session) {
  ...
  shinyalert(
    ...
    text = "This tool is for educational purposes only and does not replace professional medical or genetic consultation. Users are strongly encouraged to consult a genetic counsellor or clinician before drawing conclusions from variant information.",
    type = "warning",
    ...
    withProgress(
      ...
      value = 0, {
        ...
        if (!file.exists(txt_file)) {
          ...
          download_file("https://ftp.ncbi.nlm.nih.gov/pub/clinvar/tab_delimited/variant_summary.txt.gz", gz_file)
        } else {
          cat("...previous version found... skipping download....\n")
        }
        
        # Unzip the file using R's internal tools (to avoid dependency on system gunzip)
